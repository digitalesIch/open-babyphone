...
fun launcherDestination(
    monitorState: MonitorSessionState,
    listenState: ListenSessionState
): LauncherDestination = when {
    monitorState.isAuthoritativelyActive() -> LauncherDestination.Monitor
    listenState.isAuthoritativelyActive() -> LauncherDestination.Listen
    else -> LauncherDestination.Start
}
